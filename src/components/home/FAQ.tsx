        ...
        <div className="max-w-3xl mx-auto">
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="item-1" className="border border-white/10 rounded-md overflow-hidden">
              <AccordionTrigger className="px-6 py-4 text-left text-white hover:no-underline bg-navy-dark/50">
                Como adquirir os presentes corporativos?
              </AccordionTrigger>
              <AccordionContent className="px-6 py-4 text-white/80 bg-navy-dark/20">
